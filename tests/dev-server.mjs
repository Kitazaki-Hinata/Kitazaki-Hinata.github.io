...
put('happy/browser-text/post.json', JSON.stringify({ title: 'A text-only happy moment', date: '2099-01-02', text: 'A joy that needs no photo.\nAnother happy line.' }));
put('happy/browser-explicit-text/post.json', JSON.stringify({ date: '2099-01-01', text: 'Photos are optional.', images: [] }));
put('happy/browser-explicit-text/images/unused.svg', svg('purple'));
